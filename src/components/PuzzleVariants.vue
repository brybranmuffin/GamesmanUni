<template>
  <div id="app-game-variants">
    ...
    <h3 id="app-game-variants-subtitle">Puzzle Variants</h3>
...
export default class GameVariants extends Vue {
  ...
  get variantDataArray(): Array<TVariantData> {
    return this.$store.getters.variantDataArrayPuzzle;
  }
  ...
  async created(): Promise<void> {
    ...
    await this.$store.dispatch("initPuzzle", this.$route.params.gameId);
  }
}
</script>
